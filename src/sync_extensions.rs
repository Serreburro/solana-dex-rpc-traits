use crate::globals::*;
use crate::utils::{
    ProgramAccounts, memcmp_b58, memcmp_bytes, merge_program_accounts, pool_fetch_config,
    with_single_token_filter, with_token_pair_filters,
};
...
pub trait DexRpcClientExt {
    ...
    fn get_all_futarchy_amm_pools_by_tokens_bidirectional(
        &self,
        base_mint: &Pubkey,
        quote_mint: &Pubkey,
    ) -> ClientResult<ProgramAccounts> {
...
impl DexRpcClientExt for RpcClient {
    fn get_all_pools_with_filters(
        &self,
        program_id: Pubkey,
        filters: Vec<RpcFilterType>,
